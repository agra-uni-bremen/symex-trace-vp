...
*/
#define MAXSIZE 4 // We reduced the size of the matrix to have a quicker runtime. The original value was 20.
...
int main( void )
{
  countnegative_init();
  countnegative_main();
  countnegative_return(); // Discard result because we require symex_exit() to be called.
  symex_exit();
}
